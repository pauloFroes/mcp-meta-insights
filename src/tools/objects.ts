  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to list campaigns: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    "list_adsets",
    {
      ...
      inputSchema: {
        fields: z
          ...
          .optional()
          .describe(
            "Comma-separated fields. Default: id,name,status,effective_status,campaign_id,daily_budget,lifetime_budget,targeting,optimization_goal,billing_event,start_time,end_time"
          ),
        campaign_id: z
          .string()
          .optional()
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to list ad sets: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    "list_ads",
    {
      ...
      inputSchema: {
        fields: z
          ...
          .optional()
          .describe(
            "Comma-separated fields. Default: id,name,status,effective_status,adset_id,campaign_id,creative"
          ),
        adset_id: z
          .string()
          .optional()
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to list ads: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    "get_ad_account",
    {
      ...
      inputSchema: {
        fields: z
          ...
          .optional()
          .describe(
            "Comma-separated fields. Default: id,name,account_status,currency,timezone_name,timezone_offset_hours_utc,amount_spent,balance,spend_cap,business_name,business_city,business_country_code"
          ),
      },
      annotations: {
        readOnlyHint: true,
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to get ad account: ${(error as Error).message}`);
      }
    },
  );
}
