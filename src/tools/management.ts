  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to create campaign: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to update campaign: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async ({ campaign_id }) => {
      try {
        ...
        return toolError(`Failed to delete campaign: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    "create_adset",
    {
      ...
      inputSchema: {
        ...
        targeting: z
          .string()
          .describe(
            'JSON targeting object. Example: {"age_min":25,"age_max":55,"geo_locations":{"countries":["BR"]},"publisher_platforms":["facebook","instagram"]}'
          ),
        promoted_object: z
          .string()
          .optional()
    ...
    async (args) => {
      try {
        ...
        if (args.daily_budget) body.daily_budget = args.daily_budget;
        if (args.lifetime_budget) body.lifetime_budget = args.lifetime_budget;
        if (args.promoted_object) body.promoted_object = JSON.parse(args.promoted_object);
        ...
        return toolError(`Failed to create ad set: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        if (args.daily_budget) body.daily_budget = args.daily_budget;
        if (args.lifetime_budget) body.lifetime_budget = args.lifetime_budget;
        if (args.targeting) body.targeting = JSON.parse(args.targeting);
        ...
        return toolError(`Failed to update ad set: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async ({ adset_id }) => {
      try {
        ...
        return toolError(`Failed to delete ad set: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to create ad: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to update ad: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async ({ ad_id }) => {
      try {
        ...
        return toolError(`Failed to delete ad: ${(error as Error).message}`);
      }
    },
  );
  ...
  server.registerTool(
    "create_adcreative",
    {
      ...
      inputSchema: {
        ...
        object_story_spec: z
          .string()
          .describe(
            'JSON creative spec. Image example: {"page_id":"123","link_data":{"image_hash":"abc","link":"https://...","message":"Ad text","call_to_action":{"type":"LEARN_MORE","value":{"link":"https://..."}}}}',
          ),
      },
      annotations: {
        readOnlyHint: false,
    ...
    async (args) => {
      try {
        ...
        return toolError(`Failed to create ad creative: ${(error as Error).message}`);
      }
    },
  );
}
