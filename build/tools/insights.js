...
const COMMON_FIELDS_DESC = "Comma-separated list of metrics/dimensions. Common: impressions, clicks, spend, cpc, cpm, ctr, reach, frequency, actions, cost_per_action_type, conversions, cost_per_conversion. Default: impressions,clicks,spend,cpc,cpm,ctr,reach";
...
const insightsSchema = {
    ...
    filtering: z
        .string()
        .optional()
        .describe('JSON array of filter objects. Example: [{"field":"impressions","operator":"GREATER_THAN","value":"0"}]'),
    breakdowns: z
        .string()
        .optional()
        .describe("Comma-separated breakdowns. Common: age, gender, country, publisher_platform, device_platform, impression_device"),
...
export function registerInsightTools(server) {
    server.registerTool("get_account_insights", {
        ...
        description: "Get performance insights for the ad account. Optionally set level=campaign, adset, or ad to break down results. Use since/until for date ranges. Returns metrics like impressions, clicks, spend, cpc, cpm, ctr, reach.",
        inputSchema: {
            ...insightsSchema,
            level: z
    ...
    server.registerTool("get_campaign_insights", {
        ...
        description: "Get performance insights for a specific campaign by ID. Returns metrics like impressions, clicks, spend, cpc, cpm, ctr, reach.",
        inputSchema: {
        ...
        try {
            ...
            return toolError(`Failed to get campaign insights: ${error.message}`);
        }
    });
    server.registerTool("get_adset_insights", {
        title: "Get Ad Set Insights",
        description: "Get performance insights for a specific ad set by ID. Returns metrics like impressions, clicks, spend, cpc, cpm, ctr, reach.",
        inputSchema: {
        ...
        try {
            ...
            return toolError(`Failed to get ad set insights: ${error.message}`);
        }
    });
    server.registerTool("get_ad_insights", {
        title: "Get Ad Insights",
        description: "Get performance insights for a specific ad by ID. Returns metrics like impressions, clicks, spend, cpc, cpm, ctr, reach.",
        inputSchema: {
        ...
        try {
            ...
            return toolError(`Failed to get ad insights: ${error.message}`);
        }
    });
}
